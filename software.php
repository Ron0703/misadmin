...
// Fetch data from the software table
  ...
  <div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
      <div class="d-flex align-items-center">
        ...
        <h2 id="refresh-software" class="mb-0" style="cursor: pointer;">Software Inventory</h2>
      </div>
    </div>
    ...
    <div class="table-responsive custom-scroll">
      <table class="table custom-table table-bordered table-hover">
        ...
        ?>
          <!-- Main Row -->
          <tr id="row-<?php echo $row['id']; ?>" class="data-row <?= $highlightClass ?>" data-id="<?= $row['id'] ?>" data-table="software">
            ...
            <td class="text-center">
              <div class="d-flex justify-content-center flex-wrap gap-1">
                ...
                <!-- Delete Button -->
                <a href="delete.php?id=<?= $row['id'] ?>&table=software" 
