...
// Fetch data from the dvr table
$result = $conn->query("SELECT * FROM dvr");
  ...
  <div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
      <div class="d-flex align-items-center">
        ...
        <h2 id="refresh-dvr" class="mb-0" style="cursor: pointer;">DVR Inventory</h2>
      </div>
    </div>
    ...
    <div class="table-responsive custom-scroll">
      <table class="table custom-table table-bordered table-hover">
        ...
        ?>
          <!-- Main Row -->
          <tr id="row-<?php echo $row['id']; ?>" class="data-row <?= $highlightClass ?>" data-id="<?= $row['id'] ?>" data-table="dvr">
            ...
            <td class="text-center">
              <div class="d-flex justify-content-center flex-wrap gap-1">
                ...
                <!-- Delete Button -->
                <a href="delete.php?id=<?= $row['id'] ?>&table=dvr" 
              ...
              <form method="POST" action="edit.php">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <input type="hidden" name="table" value="dvr">
